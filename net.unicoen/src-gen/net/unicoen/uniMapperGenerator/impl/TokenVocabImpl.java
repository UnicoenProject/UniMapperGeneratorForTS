 ...
 * </p>
 * <ul>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.TokenVocabImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokenVocabImpl extends OptionImpl implements TokenVocab
{
  ...
  {
    return UniMapperGeneratorPackage.Literals.TOKEN_VOCAB;
  }
    ...
    if (importURI != null && importURI.eIsProxy())
    {
      ...
      if (importURI != oldImportURI)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UniMapperGeneratorPackage.TOKEN_VOCAB__IMPORT_URI, oldImportURI, importURI));
      }
    }
    return importURI;
  }
  ...
  public void setImportURI(Grammar newImportURI)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.TOKEN_VOCAB__IMPORT_URI, oldImportURI, importURI));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UniMapperGeneratorPackage.TOKEN_VOCAB__IMPORT_URI:
