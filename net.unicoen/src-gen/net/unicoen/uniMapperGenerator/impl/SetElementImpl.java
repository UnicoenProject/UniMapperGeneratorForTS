 ...
 * </p>
 * <ul>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.SetElementImpl#getTokenRef <em>Token Ref</em>}</li>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.SetElementImpl#getStringLiteral <em>String Literal</em>}</li>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.SetElementImpl#getRange <em>Range</em>}</li>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.SetElementImpl#getCharSet <em>Char Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetElementImpl extends MinimalEObjectImpl.Container implements SetElement
{
  ...
  {
    return UniMapperGeneratorPackage.Literals.SET_ELEMENT;
  }
  ...
  public void setTokenRef(String newTokenRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.SET_ELEMENT__TOKEN_REF, oldTokenRef, tokenRef));
  }
  ...
  public void setStringLiteral(String newStringLiteral)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.SET_ELEMENT__STRING_LITERAL, oldStringLiteral, stringLiteral));
  }
  ...
  public NotificationChain basicSetRange(Range newRange, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.SET_ELEMENT__RANGE, oldRange, newRange);
  ...
  public void setRange(Range newRange)
  {
    if (newRange != range)
    {
      ...
      if (range != null)
        msgs = ((InternalEObject)range).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.SET_ELEMENT__RANGE, null, msgs);
      if (newRange != null)
        msgs = ((InternalEObject)newRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.SET_ELEMENT__RANGE, null, msgs);
      msgs = basicSetRange(newRange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.SET_ELEMENT__RANGE, newRange, newRange));
  }
  ...
  public void setCharSet(String newCharSet)
  {
    ...
    charSet = newCharSet;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.SET_ELEMENT__CHAR_SET, oldCharSet, charSet));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UniMapperGeneratorPackage.SET_ELEMENT__RANGE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UniMapperGeneratorPackage.SET_ELEMENT__TOKEN_REF:
        return getTokenRef();
      case UniMapperGeneratorPackage.SET_ELEMENT__STRING_LITERAL:
        return getStringLiteral();
      case UniMapperGeneratorPackage.SET_ELEMENT__RANGE:
        return getRange();
      case UniMapperGeneratorPackage.SET_ELEMENT__CHAR_SET:
        return getCharSet();
    }
