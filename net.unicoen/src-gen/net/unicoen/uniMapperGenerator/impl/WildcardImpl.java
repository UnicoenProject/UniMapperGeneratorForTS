 ...
 * </p>
 * <ul>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.WildcardImpl#getDot <em>Dot</em>}</li>
 *   <li>{@link net.unicoen.uniMapperGenerator.impl.WildcardImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WildcardImpl extends MinimalEObjectImpl.Container implements Wildcard
{
  ...
  {
    return UniMapperGeneratorPackage.Literals.WILDCARD;
  }
  ...
  public void setDot(String newDot)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.WILDCARD__DOT, oldDot, dot));
  }
  ...
  public NotificationChain basicSetOptions(ElementOptions newOptions, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.WILDCARD__OPTIONS, oldOptions, newOptions);
  ...
  public void setOptions(ElementOptions newOptions)
  {
    if (newOptions != options)
    {
      ...
      if (options != null)
        msgs = ((InternalEObject)options).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.WILDCARD__OPTIONS, null, msgs);
      if (newOptions != null)
        msgs = ((InternalEObject)newOptions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.WILDCARD__OPTIONS, null, msgs);
      msgs = basicSetOptions(newOptions, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.WILDCARD__OPTIONS, newOptions, newOptions));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UniMapperGeneratorPackage.WILDCARD__OPTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UniMapperGeneratorPackage.WILDCARD__DOT:
        return getDot();
      case UniMapperGeneratorPackage.WILDCARD__OPTIONS:
        return getOptions();
    }
